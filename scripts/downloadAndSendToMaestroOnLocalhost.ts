...
import {sendToMaestroLocalhost} from "@/scripts/sendToMaestroLocalhost";
...
const cli = meow(
  ...
  Options
    ...
    --appIdentifier           Your appId as defined in app.config.ts or app.json.
                              You will find it in the "ios.bundleIdentifier" or "android.package" field.
                                > Example: com.squer.autotestwithmaestro
  ...
  Examples
    $ yarn sucrase-node scripts/downloadAndSendToMaestro.ts --platform ios --appIdentifier com.squer.autotestwithmaestro --buildProfile development-simulator
`,
  {
    flags: {
      platform: {
